  ...
  ".next/server/edge/chunks/[root-of-the-server]__1q9nw-8._.js"() {
    ...
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__1q9nw-8._.js", 74398, (e, t, r) => {
      ...
      (() => {
        "use strict";
        let r2, n, i, a, o;
        var s, l, u, c, d, h, p, f, g, v, m, b, y, _, w, E, x = { 912: (e2, t2, r3) => {
          ...
          function t2(e3, t3) {
            ...
            for (var r3 = function(e4) {
              ...
              if (d && (l.push(d), d = ""), h("OPEN")) {
                ...
                p("CLOSE"), l.push({ name: E || (x ? u++ : ""), pattern: E && !x ? v(_) : x, prefix: _, suffix: C, modifier: h("MODIFIER") || "" });
                continue;
              }
              p("END");
            }
      ...
      var n = { 943: function(t2, r2) {
        !function(n2) {
          "use strict";
          var i2 = "function", a2 = "undefined", o = "object", s = "string", l = "major", u = "model", c = "name", d = "type", h = "vendor", p = "version", f = "architecture", g = "console", v = "mobile", m = "tablet", b = "smarttv", y = "wearable", _ = "embedded", w = "Amazon", E = "Apple", x = "ASUS", C = "BlackBerry", R = "Browser", O = "Chrome", S = "Firefox", T = "Google", P = "Huawei", N = "Microsoft", A = "Motorola", I = "Opera", k = "Samsung", M = "Sharp", j = "Sony", D = "Xiaomi", L = "Zebra", q = "Facebook", U = "Chromium OS", $ = "Mac OS", B = function(e2, t3) {
            var r3 = {};
            ...
            return this.getBrowser = function() {
              ...
              var e3 = {};
              return e3[h] = void 0, e3[u] = void 0, e3[d] = void 0, X.call(e3, g2, y2.device), _2 && !e3[d] && b2 && b2.mobile && (e3[d] = v), _2 && "Macintosh" == e3[u] && r3 && typeof r3.standalone !== a2 && r3.maxTouchPoints && r3.maxTouchPoints > 2 && (e3[u] = "iPad", e3[d] = m), e3;
            }, this.getEngine = function() {
              var e3 = {};
              return e3[c] = void 0, e3[p] = void 0, X.call(e3, g2, y2.engine), e3;
            }, this.getOS = function() {
              var e3 = {};
              return e3[c] = void 0, e3[p] = void 0, X.call(e3, g2, y2.os), _2 && !e3[c] && b2 && "Unknown" != b2.platform && (e3[c] = b2.platform.replace(/chrome os/i, U).replace(/macos/i, $)), e3;
  ...
  `), Object.defineProperty(this, "__NEXT_ERROR_CODE", { value: "E1177", enumerable: false, configurable: true });
      ...
      class U {
        ...
        formatPathname() {
          ...
          }((e10 = { basePath: this[q].basePath, buildId: this[q].buildId, defaultLocale: this[q].options.forceLocale ? void 0 : this[q].defaultLocale, locale: this[q].locale, pathname: this[q].url.pathname, trailingSlash: this[q].trailingSlash }).pathname, e10.locale, e10.buildId ? void 0 : e10.defaultLocale, e10.ignorePrefix), (e10.buildId || !e10.trailingSlash) && (t10 = P(t10)), e10.buildId && (t10 = I(A(t10, `/_next/data/${e10.buildId}`), "/" === e10.pathname ? "index.json" : ".json")), t10 = A(t10, e10.basePath), !e10.buildId && e10.trailingSlash ? t10.endsWith("/") ? t10 : I(t10, "/") : P(t10);
        }
        formatSearch() {
      ...
      var $, B, H, V, F, G, X, z, W, K, J, Q, Y, Z, ee, et, er = e.i(28042);
      ...
      async function tS(t10) {
        ...
        let _2 = f2.searchParams.get(ep), w2 = new tx({ page: t10.page, input: ((d2 = (c2 = "string" == typeof f2) ? new URL(f2) : f2).searchParams.delete(ep), c2 ? d2.toString() : d2).toString(), init: { body: t10.request.body, headers: v2, method: t10.request.method, nextConfig: t10.request.nextConfig, signal: t10.request.signal } });
      ...
      let { env: tI, stdout: tk } = (null == (et = globalThis) ? void 0 : et.process) ?? {}, tM = tI && !tI.NO_COLOR && (tI.FORCE_COLOR || (null == tk ? void 0 : tk.isTTY) && !tI.CI && "dumb" !== tI.TERM), tj = (e10, t10, r2, n2) => {
      ...
      let tq = tD("\x1B[31m", "\x1B[39m"), tU = tD("\x1B[32m", "\x1B[39m"), t$ = tD("\x1B[33m", "\x1B[39m");
      tD("\x1B[34m", "\x1B[39m");
      let tB = tD("\x1B[35m", "\x1B[39m");
      tD("\x1B[38;2;173;127;168m", "\x1B[39m"), tD("\x1B[36m", "\x1B[39m");
      let tH = tD("\x1B[37m", "\x1B[39m");
      tD("\x1B[90m", "\x1B[39m"), tD("\x1B[40m", "\x1B[49m"), tD("\x1B[41m", "\x1B[49m"), tD("\x1B[42m", "\x1B[49m"), tD("\x1B[43m", "\x1B[49m"), tD("\x1B[44m", "\x1B[49m"), tD("\x1B[45m", "\x1B[49m"), tD("\x1B[46m", "\x1B[49m"), tD("\x1B[47m", "\x1B[49m"), tH(tL("\u25CB")), tq(tL("\u2A2F")), t$(tL("\u26A0")), tH(tL(" ")), tU(tL("\u2713")), tB(tL("\xBB")), new tA(1e4, (e10) => e10.length), new tA(1e4, (e10) => e10.length);
      ...
      RegExp("\\n\\s+at Suspense \\(<anonymous>\\)(?:(?!\\n\\s+at (?:body|div|main|section|article|aside|header|footer|nav|form|p|span|h1|h2|h3|h4|h5|h6) \\(<anonymous>\\))[\\s\\S])*?\\n\\s+at __next_root_layout_boundary__ \\([^\\n]*\\)"), RegExp("\\n\\s+at __next_metadata_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_viewport_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_outlet_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_instant_validation_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_instant_slot_(\\d+)__[\\n\\s]"), ew(), e.s(["config", 0, { matcher: ["/((?!api|_next/static|_next/image|favicon.ico).*)"] }, "middleware", 0, function(e10) {
        ...
        return "/" === t10 ? eu.redirect(new URL("/en-us", e10.url)) : eu.next();
      }, "runtime", 0, "experimental-edge"], 99446);
      ...
      let ry = async (e10) => tS({ ...e10, IncrementalCache: rp, incrementalCacheHandler: null, page: rm, handler: async (...e11) => {
        try {
          return await rb(...e11);
        } catch (i2) {
      ...
      e.s(["default", 0, ry, "handler", 0, r_], 42738);
    }]);
  }
});
