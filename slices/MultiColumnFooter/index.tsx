...
const MODAL_DATA = {
  privacy: {
    nl: {
      ...
      content: (
        <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
          <p>
            Uw privacy is onze hoogste prioriteit. <strong className="font-semibold text-slate-800">SymVentra</strong> verwerkt persoonsgegevens in strikte overeenstemming met de Algemene Verordening Gegevensbescherming (AVG/GDPR).
          </p>
          <p>
    ...
    en: {
      ...
      content: (
        <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
          <p>
            Your privacy is our top priority. <strong className="font-semibold text-slate-800">SymVentra</strong> processes personal data in strict compliance with the General Data Protection Regulation (GDPR).
          </p>
          <p>
            Your data is processed only with your explicit consent and protected using advanced technical and organizational measures.
          </p>
          <div className="pt-2">
            <a href="#" className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#00c8c8] hover:underline">
    ...
    en: {
      ...
      content: (
        <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
          ...
          <p>
            Always consult a qualified healthcare professional regarding any medical questions or before making major changes to your health regimen.
          </p>
        </div>
      ),
    },
  ...
  research: {
    nl: {
      ...
      content: (
        <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
          <p>Deelname aan onze onderzoeksinitiatieven en citizen science-projecten is volledig vrijwillig.</p>
          <p>Waar van toepassing worden onderzoeken uitgevoerd met uitdrukkelijke geïnformeerde toestemming, strikt volgens hoge internationale ethische normen en AVG-regelgeving.</p>
        </div>
      ),
    },
    en: {
      ...
      content: (
        <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
          <p>Participation in our research initiatives and citizen science projects is completely voluntary.</p>
          <p>Where applicable, studies are conducted with explicit informed consent in strict accordance with ethical standards and GDPR regulations.</p>
        </div>
      ),
    },
  },
  terms: {
    nl: {
      ...
      content: (
        <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
          <p>Welkom bij <strong className="font-semibold text-slate-800">SymVentra</strong>. Door toegang te krijgen tot of gebruik te maken van onze diensten, gaat u akkoord met en bent u gebonden aan deze Algemene Voorwaarden.</p>
          <p>U stemt ermee in het platform uitsluitend voor rechtmatige doeleinden te gebruiken. Ongeautoriseerd gebruik van onze intellectuele eigendom is ten strengste verboden.</p>
        </div>
      ),
    },
    en: {
      ...
      content: (
        <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
          <p>Welcome to <strong className="font-semibold text-slate-800">SymVentra</strong>. By accessing or using our services, you agree to be bound by these Terms and Conditions.</p>
          <p>You agree to use the platform solely for lawful purposes. Unauthorized use of our intellectual property is strictly prohibited.</p>
        </div>
      ),
    },
  },
...
const MultiColumnFooter = ({ slice, locale = "nl" }: MultiColumnFooterProps): React.JSX.Element => {
  ...
  return (
    <>
      ...
      >
        {/* Dynamic Multi-Column Footer Grid */}
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-16 border-b border-slate-800/80">
          {columns.map((column, index) => (
            <div key={index} className="flex flex-col space-y-4">
              ...
              {/* RESTORED: Stay Updated / Newsletter Signup Block */}
                ...
                <div className="flex flex-col space-y-4 text-sm">
                  ...
                  >
                    ...
                    <input
                      id={`email-${index}`}
                      type="email"
                      placeholder={column.email_placeholder || (currentLang === "nl" ? "Vul uw e-mailadres in" : "Enter your email")}
                    ...
                    >
                      {column.submit_button_label || (currentLang === "nl" ? "Aanmelden" : "Subscribe")}
                    </button>
                  </form>
                </div>
              )}
        ...
        {/* RESTORED: Footer Bottom & Copyright */}
        <div className="max-w-7xl mx-auto pt-8 flex items-center justify-between text-xs text-slate-500">
          <div className="w-full text-left space-y-2">
            <p>
              <strong className="text-slate-400">Disclaimer:</strong> SymVentra is a personalized wellness platform providing evidence-based lifestyle advice. It does not provide medical advice, diagnosis, or treatment. Personal data is processed in accordance with GDPR. © {year ?? "2026"} SymVentra B.V. All rights reserved.
            </p>
            <p>
              <strong className="text-slate-400">Copyright © {year ?? "2026"} SymVentra.</strong> All content, software, algorithms, reports, designs, and trademarks on this website are the intellectual property of SymVentra B.V.
            </p>
          </div>
